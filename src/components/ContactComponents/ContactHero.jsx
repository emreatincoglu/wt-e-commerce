...
function ContactHero() {
  return (
    <section className="bg-white font-['Montserrat',ui-sans-serif,system-ui]">
      <div className="mx-auto grid min-h-[742px] max-w-[1050px] items-center gap-10 px-5 py-12 sm:px-6 md:grid-cols-2 md:py-16 lg:grid-cols-[469px_1fr] lg:gap-12 lg:px-0">
        <div className="text-center md:text-left">
          ...
          <p className="mx-auto mt-[35px] max-w-[376px] text-xl leading-[30px] tracking-[0.2px] text-[#737373] md:mx-0">
            We know how large objects will act, but things on a small scale.
          </p>
          <div className="mt-[35px] space-y-[15px] text-xl font-bold leading-8 tracking-[0.1px] text-[#252b42] sm:text-2xl">
        ...
        <div className="relative mx-auto aspect-square w-full max-w-[531px] overflow-hidden">
          ...
          <img
            alt=""
            className="absolute bottom-0 left-1/2 h-[106%] max-w-none -translate-x-1/2 object-contain"
