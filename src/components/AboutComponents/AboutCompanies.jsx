  ...
  return (
    <section className="bg-[#fafafa] py-20 font-['Montserrat',ui-sans-serif,system-ui]">
      <div className="mx-auto max-w-[1050px] px-6 text-center md:px-0">
        <h2 className="text-[32px] font-bold leading-10 tracking-[0.2px] text-[#252b42] sm:text-[40px] sm:leading-[50px]">
        ...
        <div className="mt-[60px] grid grid-cols-2 items-center justify-items-center gap-10 text-[#737373] sm:grid-cols-3 lg:grid-cols-5">
